...
function countdown() {
  const countDate = new Date("September 12, 2026 10:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  musicControlInline.addEventListener('click', toggleMusic);
  ...
  function setMusicIcon(svg) {
    musicControlInline.innerHTML = svg;
  }
...
const UCAPAN_URL = 'https://script.google.com/macros/s/AKfycbzS9JmzUXuXV_N9F-MU9IofdO5KS6hT2NkWVP3U1O3Wev7DwB_1rsdGwmQNXZUyY43t/exec';
